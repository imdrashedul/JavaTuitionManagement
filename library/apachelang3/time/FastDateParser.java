...
public class FastDateParser implements DateParser, Serializable {
    ...
    //-----------------------------------------------------------------------
    /* (non-Javadoc)
     * @see library.apachelang3.time.DateParser#getPattern()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see library.apachelang3.time.DateParser#getTimeZone()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see library.apachelang3.time.DateParser#getLocale()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see library.apachelang3.time.DateParser#parseObject(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see library.apachelang3.time.DateParser#parse(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see library.apachelang3.time.DateParser#parseObject(java.lang.String, java.text.ParsePosition)
     */
    @Override
     ...
     *
     * @see library.apachelang3.time.DateParser#parse(java.lang.String, java.text.ParsePosition)
     */
    @Override
