 ...
 * However {@link library.apachelang3.CharSet} is not currently guaranteed thread-safe under all circumstances.</p>
 *
 * <p>The top level package contains various Utils classes, whilst there are various subpackages including {@link library.apachelang3.math}, {@link library.apachelang3.concurrent} and {@link library.apachelang3.builder}.
 ...
 * The first is {@link library.apachelang3.StringUtils}, oodles and oodles of functions which tweak, transform, squeeze and cuddle {@link java.lang.String java.lang.Strings}.
 * In addition to StringUtils, there are a series of other String manipulating classes; {@link library.apachelang3.RandomStringUtils} and {@link library.apachelang3.StringEscapeUtils StringEscapeUtils}.
 ...
 * StringUtils' {@link library.apachelang3.StringUtils#capitalize(String)}, {@link library.apachelang3.StringUtils#substringBetween(String, String)}/{@link library.apachelang3.StringUtils#substringBefore(String, String) Before}/{@link library.apachelang3.StringUtils#substringAfter(String, String) After}, {@link library.apachelang3.StringUtils#split(String)} and {@link library.apachelang3.StringUtils#join(Object[])} are good methods to begin with.</p>
 *
 ...
 * {@link library.apachelang3.CharUtils} exists for this purpose, while {@link library.apachelang3.CharSetUtils} exists for set-manipulation of Strings.
 ...
 *
 * <p>{@link library.apachelang3.CharRange} and {@link library.apachelang3.CharSet} are both used internally by CharSetUtils, and will probably rarely be used.</p>
 *
 ...
 *
 * <p>The {@link library.apachelang3.CharEncoding} class is also used to interact with the Java environment and may be used to see which character encodings are supported in a particular environment. </p>
 *
 ...
 *
 * <p>Would you believe it, {@link library.apachelang3.ObjectUtils} contains handy functions for Objects, mainly null-safe implementations of the methods on {@link java.lang.Object}.</p>
 *
 * <p>{@link library.apachelang3.ClassUtils} is largely a set of helper methods for reflection.
 ...
 *
 * <p>Next up, {@link library.apachelang3.ArrayUtils}.
 ...
 * </ul>
 *
 * <p>Lastly, {@link library.apachelang3.ArrayUtils#toMap(Object[])} is worthy of special note.
 ...
 * </pre>
 *
 * <p>Our final util class is {@link library.apachelang3.BooleanUtils}.
 * It contains various Boolean acting methods, probably of most interest is the {@link library.apachelang3.BooleanUtils#toBoolean(String)} method which turns various positive/negative Strings into a Boolean object, and not just true/false as with Boolean.valueOf.</p>
 *
 ...
 * <p>The {@link library.apachelang3.BitField} class provides a wrapper class around the classic bitmask integer, whilst the {@link library.apachelang3.Validate} class may be used for assertions (remember, we support Java 1.2). </p>
 *
 * @since 1.0
 */
package library.apachelang3;
